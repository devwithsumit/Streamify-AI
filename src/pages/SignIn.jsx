...
import handleAuthSubmit from '../services/authService';
...
const SignIn = () => {
  ...
  // }
  return (
    <div className={`block min-h-[100vh] relative pt-28 global-px bg-center bg-cover bg-[url(https://raw.githubusercontent.com/thatanjan/netflix-clone-yt/youtube/media/banner.jpg)]`}>
      <div className="div absolute z-0 w-full h-full bg-gradient-to-r from-black/88 via-black/75 to-black/1 left-0 top-0"></div>
      <form className="max-w-sm relative z-10 bg-black/50 w-full mx-auto border border-neutral-500 p-4 rounded-xl" onSubmit={(e) => { e.preventDefault(); handleAuthSubmit(false, isSignUp, email, password) }}>
        ...
        {isSignUp && (
          <div className="mb-5">
            ...
            <input value={fullname} autoComplete='name' onChange={(e) => setFullName(e.target.value)}
        ...
        <button onClick={() => handleAuthSubmit(true, isSignUp, email,password)} type='button'
