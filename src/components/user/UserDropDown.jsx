...
const UserDropDown = ({user, handleSignOut}) => {
  return (
      <div id="user-dropdown" className="z-[100] hidden my-4 absolute top-8 -right-2 sm:-right-2 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600"
          ...
          <ul onClick={() => document.getElementById("user-dropdown").classList.add("hidden")}
