...
const UserDropDown = ({user, handleSignOut}) => {
  return (
      <div id="user-dropdown" className="z-[100] hidden absolute my-4 top-8 -right-5 sm:-right-2 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600"
